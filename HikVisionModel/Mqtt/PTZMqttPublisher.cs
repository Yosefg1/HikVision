...
public class PTZMqttPublisher : IPTZMqttPublisher
{
    ...
    public async Task<bool> Publish<T>(T dto, string topic = nameof(PTZControl)) where T : BaseDto //string topic = nameof(PTZControl)
    {
    ...
    public async Task<bool> Publish<T>(T dto) where T : BaseDto //string topic = nameof(PTZControl)
    {
        var msg = new MqttApplicationMessageBuilder()
